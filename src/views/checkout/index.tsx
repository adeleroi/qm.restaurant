    ...
    return (
        <div className="w-full">
            <div className="w-full h-72 relative">
                <MapBoxMap/>
                {/* <div className="absolkute inset-0 bg-hero-overlay"></div> */}
            </div>
                        ...
                        <div className="bg-white rounded-xl shadow-xl w-full h-[70vh] sticky top-40 px-4">
                            <div className="pt-6 flex items-center">
                                <div className="overflow-hidden w-20 h-20 border-[1px] shadow-custom bg-white rounded-full flex justify-center items-center mr-2 mb-4 px-2">
                                    <img className="object-contain 2-24 h-24" src="https://static.wixstatic.com/media/f0ea0e_8a3f9c414c8a4cbd90c27f1483235841~mv2.png" alt="lcbo-logo"/>
                                </div>
                                <p className="font-bold">African BBQ</p>
                            </div>
