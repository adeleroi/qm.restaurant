...
import { ArrowButton } from "../utils/button";
...
export function Home() {
    return (
        <>
            ...
            <div className='my-16'>
                <H2 variant='black' className='text-black font-semibold text-center mb-2'>Order your <span className='text-defaultGreen'>food</span></H2>
                <p>Make your choice from a wide variety of culturally diverse dishes</p>
            </div>
            ...
            <section className='bg-brown-bg h-[550px] flex items-center justify-center py-8' id='blog'>
                ...
                <img className='absolute w-52 h-52 ring-4 ring-purple-600 ring-offset-4 rounded-2xl object-cover -top-2 -left-16 origin-center rotate-45' src="https://as2.ftcdn.net/v2/jpg/06/66/40/51/1000_F_666405168_oPJGLEWNZxq83VhFTyHAzQYwS6V6VnuH.jpg" />
                <img className='absolute w-52 h-52 ring-4 ring-orange-500 ring-offset-4 rounded-2xl object-cover left-20 origin-bottom rotate-12' src="https://images.pexels.com/photos/5929/food-salad-dinner-eating.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" />
                <img className='absolute w-52 h-52 ring-4 ring-black ring-offset-4 rounded-2xl -bottom-8 -left-10 origin-bottom -rotate-12' src="https://images.unsplash.com/photo-1611712142269-12b7433e28e9?q=80&w=3024&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                </div>
